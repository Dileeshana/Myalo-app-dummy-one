...
class _VrPlayerPageState extends State<VrPlayerPage>
  ...
  void onViewPlayerCreated(
    ...
    _viewPlayerController.loadVideo(
      // videoUrl: 'https://youtu.be/P3l9o31AoeQ',
      videoPath: 'D:/SLIIT/Y4/Research/App/Myalo-app/lib/images/video/vr_video_1.mp4',
    );
  }
  ...
  void onReceiveEnded(bool isFinished) {
    if (kDebugMode) {
      print('Video Finished: $isFinished');
    }
    setState(() {
